...
client.on('ready',  () => {
    console.log('طھظ… طھط´ط؛ظٹظ„ :Broadcast  ');
  ...
  client.on("message", message => {
    if (message.content === prefix + "help")){
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**Help|ظ‡ظٹظ„ط¨

       ${prefix}obc | ظ„ط£ط±ط³ط§ظ„ ط¨ط±ظˆط¯ ظƒط§ط³طھ ظ„ظ„ظƒظ„

       ${prefix}bc  |  ظ„ط£ط±ط³ط§ظ„ ط¨ط±ظˆط¯ ظƒط§ط³طھ ظ„ظ„ط£ظˆظ†ظ„ط§ظٹظ†

       ${prefix}inv | ظ„ط¯ط¹ظˆط© ط§ظ„ط¨ظˆطھ ط§ظ„ظٹ ط³ظٹط±ظپط±ظƒ
